 ...
 * divided into two sub concepts; the first being local properties (not sticky)
 * that are only persisted by command and the second being a preferences object
 * that automatically saves values (sticky). </p> <p><b>Local Properties</b> The
 * SwingViewBuilder uses local properties to build the AWT Viewer. The viewer
 * will always have a default state which can be altered with the
 * checkAndStore*Property() methods. A given viewer configuration state can be
 * persisted to the preference object with a call to saveStoreProperties(). Once
 * local properties are persisted the only way to restore the default state is
 * to call clearPreferences() or configure a customer ICEpdfDefault.properties
 * file. </p> <p><b>Preferences</b> The preferences object can be directly
 * accessed via the accessor to directly access the preference api. </p>
 * <p><b>Default Properties</b> The default viewer ri ships with a
 * ICEpdfDefault.properties file that can be used to load default viewer
 * properties for custom builds. This mechanism can be easier to implement then
 * manually manipulating the PropertyManagers before the a swing view is
 * created. </p>
 *
 * @since 6.3
 */
...
public class PropertiesManager {
	...
	public static String DEFAULT_MESSAGE_BUNDLE =
		"org.icepdf.ri.resources.MessageBundle";
	...
	public static final String PROPERTY_PRINT_MEDIA_SIZE_WIDTH =
		"document.print.mediasize.width";

	/** The Constant PROPERTY_PRINT_MEDIA_SIZE_HEIGHT. */
	public static final String PROPERTY_PRINT_MEDIA_SIZE_HEIGHT =
		"document.print.mediasize.height";

	/** The Constant PROPERTY_PRINT_MEDIA_SIZE_UNIT. */
	public static final String PROPERTY_PRINT_MEDIA_SIZE_UNIT =
		"document.print.mediasize.unit";
	...
	public static final String PROPERTY_SHOW_STATUSBAR_VIEWMODE_DOUBLE_CONTINUOUS =
		"application.statusbar.show.viewmode.double.page.continuous";
	...
	public static final String PROPERTY_SHOW_UTILITYPANE_ANNOTATION_MARKUP =
		"application.utilitypane.show.annotation.markup";
	...
	public static final String PROPERTY_SHOW_UTILITYPANE_ANNOTATION_DESTINATIONS =
		"application.utilitypane.show.annotation.dests";
	...
	public static final String PROPERTY_SHOW_PREFERENCES_GENERAL =
		"application.preferences.show.general";
	...
	public static final String PROPERTY_UTILITYPANE_THUMBNAILS_ZOOM =
		"application.utilitypane.thumbnail.zoom";
	...
	public static final String PROPERTY_SHOW_KEYBOARD_SHORTCUTS =
		"application.menuitem.show.keyboard.shortcuts";
	...
	public static final String PROPERTY_ANNOTATION_HIGHLIGHT_SELECTION_ENABLED =
		"application.annotation.highlight.selection.enabled";

	/** The Constant PROPERTY_ANNOTATION_LINE_SELECTION_ENABLED. */
	public static final String PROPERTY_ANNOTATION_LINE_SELECTION_ENABLED =
		"application.annotation.line.selection.enabled";

	/** The Constant PROPERTY_ANNOTATION_LINK_SELECTION_ENABLED. */
	public static final String PROPERTY_ANNOTATION_LINK_SELECTION_ENABLED =
		"application.annotation.link.selection.enabled";

	/** The Constant PROPERTY_ANNOTATION_SQUARE_SELECTION_ENABLED. */
	public static final String PROPERTY_ANNOTATION_SQUARE_SELECTION_ENABLED =
		"application.annotation.rectangle.selection.enabled";

	/** The Constant PROPERTY_ANNOTATION_CIRCLE_SELECTION_ENABLED. */
	public static final String PROPERTY_ANNOTATION_CIRCLE_SELECTION_ENABLED =
		"application.annotation.circle.selection.enabled";

	/** The Constant PROPERTY_ANNOTATION_INK_SELECTION_ENABLED. */
	public static final String PROPERTY_ANNOTATION_INK_SELECTION_ENABLED =
		"application.annotation.ink.selection.enabled";

	/** The Constant PROPERTY_ANNOTATION_FREE_TEXT_SELECTION_ENABLED. */
	public static final String PROPERTY_ANNOTATION_FREE_TEXT_SELECTION_ENABLED =
		"application.annotation.freetext.selection.enabled";

	/** The Constant PROPERTY_ANNOTATION_TEXT_SELECTION_ENABLED. */
	public static final String PROPERTY_ANNOTATION_TEXT_SELECTION_ENABLED =
		"application.annotation.text.selection.enabled";

	/** The Constant PROPERTY_ANNOTATION_PROPERTIES_HIGHLIGHT_ENABLED. */
	// properties used to control visibility of annotation controls on main
	// utility panel.
	public static final String PROPERTY_ANNOTATION_PROPERTIES_HIGHLIGHT_ENABLED =
		"application.annotation.properties.highlight.enabled";
	...
	public static final String PROPERTY_ANNOTATION_PROPERTIES_UNDERLINE_ENABLED =
		"application.annotation.properties.underline.enabled";
	...
	public static final String PROPERTY_ANNOTATION_PROPERTIES_STRIKE_OUT_ENABLED =
		"application.annotation.properties.strikeout.enabled";
	...
	public static final String PROPERTY_ANNOTATION_PROPERTIES_LINE_ENABLED =
		"application.annotation.properties.line.enabled";
	...
	public static final String PROPERTY_ANNOTATION_PROPERTIES_LINK_ENABLED =
		"application.annotation.properties.link.enabled";
	...
	public static final String PROPERTY_ANNOTATION_PROPERTIES_ARROW_ENABLED =
		"application.annotation.properties.arrow.enabled";
	...
	public static final String PROPERTY_ANNOTATION_PROPERTIES_RECTANGLE_ENABLED =
		"application.annotation.properties.rectangle.enabled";
	...
	public static final String PROPERTY_ANNOTATION_PROPERTIES_CIRCLE_ENABLED =
		"application.annotation.properties.circle.enabled";
	...
	public static final String PROPERTY_ANNOTATION_PROPERTIES_INK_ENABLED =
		"application.annotation.properties.ink.enabled";
	...
	public static final String PROPERTY_ANNOTATION_PROPERTIES_FREE_TEXT_ENABLED =
		"application.annotation.properties.freetext.enabled";
	...
	public static final String PROPERTY_SHOW_TOOLBAR_ANNOTATION_SELECTION =
		"application.toolbar.annotation.selection.enabled";
	...
	public static final String PROPERTY_SHOW_TOOLBAR_ANNOTATION_HIGHLIGHT =
		"application.toolbar.annotation.highlight.enabled";
	...
	public static final String PROPERTY_SHOW_TOOLBAR_ANNOTATION_UNDERLINE =
		"application.toolbar.annotation.underline.enabled";
	...
	public static final String PROPERTY_SHOW_ANNOTATION_MARKUP_REPLY_TO =
		"application.annotation.show.markup.replyTo";
	...
	public static final String PROPERTY_ANNOTATION_LINE_ARROW_FILL_COLOR =
		"application.viewer.preference.annotation.arrow.fill.color";

	/** The Constant PROPERTY_ANNOTATION_LINE_ARROW_OPACITY. */
	public static final String PROPERTY_ANNOTATION_LINE_ARROW_OPACITY =
		"application.viewer.preference.annotation.arrow.fill.opacity";
	...
	public static final String PROPERTY_ANNOTATION_FREE_TEXT_BORDER_COLOR =
		"application.viewer.preference.annotation.freetext.border.color";
	...
	public static final String PROPERTY_ANNOTATION_RECENT_COLORS =
		"application.viewer.preference.annotation.color.recent";

	/** The Constant PROPERTY_ANNOTATION_RECENT_COLOR_LABEL. */
	// resent colour and labels, enabled automatically if there is more then
	// one.
	public static final String PROPERTY_ANNOTATION_RECENT_COLOR_LABEL =
		"application.viewer.preference.annotation.recent.color.labels";
	...
	public static final String PROPERTY_SEARCH_PANEL_REGEX_ENABLED =
		"application.viewer.utility.search.regex.enabled";
	...
	public static final String PROPERTY_SEARCH_PANEL_WHOLE_WORDS_ENABLED =
		"application.viewer.utility.search.whole.words.enabled";
	...
	public static final String PROPERTY_SEARCH_PANEL_SEARCH_COMMENTS_ENABLED =
		"application.viewer.utility.search.comments.cumulative.enabled";
	...
	public static final String PROPERTY_SEARCH_PANEL_SEARCH_DEST_ENABLED =
		"application.viewer.utility.search.case.destinations.enabled";
	...
	public static final String PROPERTY_SEARCH_PANEL_SEARCH_TEXT_ENABLED =
		"application.viewer.utility.search.case.text.enabled";
	...
	public static final String PROPERTY_SEARCH_MARKUP_PANEL_REGEX_ENABLED =
		"application.viewer.utility.search.markup.regex.enabled";
	...
	public static final String PROPERTY_SEARCH_MARKUP_PANEL_CASE_SENSITIVE_ENABLED =
		"application.viewer.utility.search.markup.case.sensitive.enabled";
	...
	private static Preferences preferences =
		Preferences.userNodeForPackage(PropertiesManager.class);

	/** The local properties. */
	// local properties, that aren't persisted and can override properties in
	// the store if root accessor are used.
	...
	public static PropertiesManager getInstance() {
		...
		if (propertiesManager == null) {
			...
			// load default properties from viewer jar and assigned to
			// defaultProps.
	...
	/**
	 * Gets the Preferences backing store for persisting static properties and
	 * settings.
	 *
	...
	/**
	 * Sets the local property over writing any previous value stored in the
	...
	/**
	 * All of the properties that are stored in the local properties can be
	 * persisted to the backing store via this method call. The local properties
	 * are stored via the checkAndStore*() method calls and should only be used
	 * when configuring the viewer components functionality. Once these
	 * properties have been persisted they are now sticky and will persist for
	 * all viewer instances.
	 */
	...
	/**
	 * Sets the local double property over writing any previous value stored in
	...
	/**
	 * Sets the local float property over writing any previous value stored in
	 * the default properties file.
	 *
	 * @param propertyName
	 *            name of property to write.
	...
	/**
	 * Sets the local integer property over writing any previous value stored in
	 * the default properties file.
	 *
	 * @param propertyName
	 *            name of property to write.
	...
	/**
	 * Sets the local boolean property over writing any previous value stored in
	 * the default properties file.
	 *
	 * @param propertyName
	 *            name of property to write.
	...
	/**
	 * Method to check the value of a string property This is meant to be used
	 * for configuration via the properties file After the property has been
	 * checked, it will be stored back into the Properties object (using a
	 * default value if none was found).
	 *
	 * @param propertyName
	 *            to check for
	 * @param defaultVal
	 *            to default to if no value is found on a property
	 * @return String value for the propertyName or defaultVal if none exists.
	 */
	public String checkAndStoreStringProperty(
		String propertyName, String defaultVal) {

		// Get the desired property, defaulting to the defaultVal parameter
		String returnValue =
			localProperties.getProperty(propertyName, defaultVal);
		// Set the property back into the manager
		// This is necessary in the cases where a property didn't exist, but
	...
	/**
	 * Method to check the value of a boolean property This is meant to be used
	 * for configuration via the properties file After the property has been
	 * checked, it will be stored back into the Properties object (using a
	 * default value if none was found).
	 *
	 ...
	 */
	public boolean checkAndStoreBooleanProperty(
		String propertyName, boolean defaultVal) {

		// Get the desired property, defaulting to the defaultVal parameter
		boolean returnValue = Boolean.parseBoolean(
			localProperties.getProperty(
				propertyName, Boolean.toString(defaultVal)));
		// Set the property back into the manager
		// This is necessary in the cases where a property didn't exist, but
		// needs to be added to the file
		localProperties.put(propertyName, returnValue);
	...
	/**
	 * Method to check the value of a double property This is meant to be used
	 * for configuration via the properties file After the property has been
	 * checked, it will be stored back into the Properties object (using a
	 * default value if none was found).
	 *
	 ...
	 */
	public double checkAndStoreDoubleProperty(
		String propertyName, double defaultVal) {

		// Get the desired property, defaulting to the defaultVal parameter
		double returnValue = Double.parseDouble(
			localProperties.getProperty(
				propertyName, Double.toString(defaultVal)));
		// Set the property back into the manager
		// This is necessary in the cases where a property didn't exist, but
		// needs to be added to the file
		localProperties.put(propertyName, returnValue);
	...
	/**
	 * Method to check the value of an int property This is meant to be used for
	 * configuration via the properties file After the property has been
	 * checked, it will be stored back into the Properties object (using a
	 * default value if none was found).
	 *
	 * @param propertyName
	...
	public int checkAndStoreIntProperty(String propertyName, int defaultVal) {
		...
		int returnValue = Integer.parseInt(
			localProperties.getProperty(
				propertyName, Integer.toString(defaultVal)));
		// Set the property back into the manager
		// This is necessary in the cases where a property didn't exist, but
		// needs to be added to the file
		localProperties.put(propertyName, returnValue);
	 ...
	 * @return int value of property
	 */
	public float checkAndStoreFloatProperty(
		String propertyName, float defaultVal) {

		// Get the desired property, defaulting to the defaultVal parameter
		float returnValue = Float.parseFloat(
			localProperties.getProperty(
				propertyName, Float.toString(defaultVal)));
		// Set the property back into the manager
		// This is necessary in the cases where a property didn't exist, but
		// needs to be added to the file
		localProperties.put(propertyName, returnValue);
	...
	/**
	 * Method to check the value of a comma separate list of floats property For
	 * example we will convert "0.4f, 0.5f, 0.6f" to a size 3 array with the
	 * values as floats This is meant to be used for configuration via the
	 * properties file After the property has been checked, it will be stored
	 * back into the Properties object (using a default value if none was found)
	 *
	 * @param propertyName
	 *            to check for
	 * @param defaultVal
	 ...
	 */
	public float[] checkAndStoreFloatArrayProperty(
		String propertyName, float[] defaultVal) {
		...
		try {
			...
			// Then we'll convert the comma separated property to a list of
			// floats
			if ((propertyString != null) &&
				...
				for (int i = 0; i < split.length; i++) {
					try {
						...
						/*
						 * ignore as we'll just automatically put a '0' in the
						 * invalid space
						 */
					}
				}
			...
			// This is done so it can be stored back into the properties file
				...
				StringBuilder commaBuffer =
					new StringBuilder(defaultVal.length * 2);
				...
				// Set the property back into the manager
				// This is necessary in the cases where a property didn't exist,
				// but needs to be added to the file
	 ...
	 *
	 * @param propertyName
	 *            look and feel class and package name.
	 * @param defaultValue
	 *            default value
	 * @param messageBundle
	 *            message bundle.
		...
		if (defaultProps != null) {
			...
			if (value != null) {
				...
				Resources.showMessageDialog(
					null, JOptionPane.ERROR_MESSAGE, messageBundle,
					"manager.properties.title", "manager.properties.lafError",
					value);
			}
		}
		return defaultValue;
	...
	/**
	 * This utility method removes all entries in the preferences backing store.
	 * This method does not remove the preferences node and thus the font
	 * manager font cache is unaffected.
	 */
	public void clearPreferences() {
		...
		try {
			...
			if (logger.isLoggable(Level.WARNING)) {
				logger.log(
					Level.WARNING, "Error clearing preferences cache", ex);
			}
		}
	...
	private static void setupDefaultProperties() {
		...
		try (InputStream in =
			getResourceAsStream(DEFAULT_PROP_FILE_PATH, DEFAULT_PROP_FILE)) {
			...
			if (in != null) {
				...
				logger.finer(
					"Default properties file could not be found on the class path. ");
			}
		}
		catch (Throwable ex) {
			// log the error
