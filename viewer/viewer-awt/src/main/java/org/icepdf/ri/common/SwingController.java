...
import static org.icepdf.ri.util.PropertiesManager.PROPERTY_RECENTLY_OPENED_FILES;
import static org.icepdf.ri.util.PropertiesManager.PROPERTY_RECENT_FILES_SIZE;
import static org.icepdf.ri.util.PropertiesManager.PROPERTY_TOKEN_SEPARATOR;
...
//            }
    ...
    protected void setCursorOnComponents(final int cursorType) {
...
//        }
    ...
    protected void reflectSelectionInButton(AbstractButton btn, boolean selected) {
        if (btn != null) {
